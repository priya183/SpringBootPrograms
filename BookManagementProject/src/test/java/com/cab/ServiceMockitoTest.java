...
public class ServiceMockitoTest {
	...
	@Test
	public void test_getBookByIdd()
	{
		Optional<Book> b=Optional.of(new Book(1, "cpp", "priya", 700));
		
		int bookId=1;
		
		when(bookRepo.findById(bookId)).thenReturn(b);
		
		assertEquals(bookId, bookService.getBookByIdd(bookId).getId()); 
	}
